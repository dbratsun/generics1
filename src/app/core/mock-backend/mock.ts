...
export const UNITS: Unit[] = [
    { id: 1, name: 'штуки', shortname: 'шт', code: '01', description: 'this is a quantity'},
    { id: 2, name: 'метры', shortname: 'м', code: '02', description: 'this is a meter'},
    { id: 3, name: 'квадратные метры', shortname: 'м2', code: '03', description: 'this is a square meter'},
    { id: 4, name: 'килограммы', shortname: 'кг', code: '04', description: 'this is a kilo'}
];
